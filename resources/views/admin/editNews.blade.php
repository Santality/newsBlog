...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="my-3">Редактировать новость</h1>
            <form method="POST" action="/updateNews" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea class="form-control" name="content" id="content" style="height: 100px">{{$item->content}}</textarea>
                    @error('content')
                        <div class="alert alert-danger alert-dismissible">
                            <div class="alert-text">
                                {{ $message }}
                ...
                <button type="submit" class="btn btn-info mt-3">Изменить</button>
            </form>
            @if (session('success'))
